...
import { Space_Mono, IBM_Plex_Sans, JetBrains_Mono, Source_Serif_4 } from "next/font/google";
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="scroll-smooth">
      <body
        className={`${spaceMono.variable} ${ibmPlexSans.variable} ${jetbrainsMono.variable} ${sourceSerif.variable} font-body bg-transparent text-text-primary antialiased relative`}
      >
