...
function StatCard({ 
  ...
  return (
    ...
    >
      <GlowCard customSize={true} glowColor={glowColor} className="w-full min-h-[220px] group hover:-translate-y-1 transition-all duration-300">
        <div className="flex flex-col items-center justify-center w-full h-full p-8 min-h-[220px]">
...
export function Problem() {
  return (
    <BackgroundPaths>
      <section id="problem" className="py-24 relative z-10 w-full">
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <p className="text-white/60 font-source-serif text-[15px] leading-relaxed italic opacity-90">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            >
              <GlowCard customSize={true} glowColor="red" className="w-full min-h-[400px] overflow-hidden relative">
                <FluidGlass 
                  mode="lens" 
                  lensProps={{ 
                    thickness: 0.8, 
            ...
            >
              <GlowCard customSize={true} glowColor="green" className="w-full min-h-[400px] overflow-hidden relative">
                <FluidGlass 
                  mode="lens" 
                  lensProps={{ 
                    thickness: 0.8, 
