...
import { useDiagram, DiagramOutput } from '@/hooks/useDiagram';
import {
  Upload, Zap, Download, Copy, Maximize2, Loader, AlertTriangle, Info,
} from 'lucide-react';
...
export default function ArchitectureDiagram({ embeddedHcl }: { embeddedHcl?: string }) {
  const { data: diagramData, loading, error, generateDiagram, setData } = useDiagram();
