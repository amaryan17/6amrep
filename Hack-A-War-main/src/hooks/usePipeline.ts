...
export function usePipeline() {
  ...
  const startPolling = useCallback(
    ...
    [] // Removing startPolling from its dependencies since it's itself
  );
        ...
        es.addEventListener("progress", (event) => {
          try {
            ...
            setState((prev) => {
              ...
              if (parsedData.stage < newStages.length) {
                newStages[parsedData.stage] = {
                  ...newStages[parsedData.stage],
              ...
              return {
                ...
                progress: {
                  ...prev.progress,
                  current_stage: parsedData.stage,
                  stages: newStages,
                },
              };
            });
