    ...
    <BackgroundPaths>
      <section id="demo" className="py-24 relative">
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          >
            <h2 className="font-display text-4xl md:text-5xl font-bold text-white mb-4 drop-shadow-[0_0_10px_rgba(57,255,20,0.3)]">See It Work</h2>
            <p className="font-source-serif text-[15px] text-[#FF4444] leading-relaxed italic opacity-90">One upload triggers the full autonomous pipeline.</p>
          </motion.div>
              ...
              return (
                <button
                  ...
                  className={cn(
                    ...
                    isActive ? "text-[#39FF14] drop-shadow-[0_0_8px_rgba(57,255,20,0.5)]" : "text-white/30 hover:text-white/60"
                  )}
                >
                  {tab.title}
                  {isActive && (
                     <motion.div
                        ...
                        className="absolute bottom-0 left-0 w-full h-[2px] bg-[#39FF14] shadow-[0_0_8px_rgba(57,255,20,0.5)]"
                     />
                  )}
                </button>
              );
          ...
          {/* Tab Content */}
          <GlowCard customSize={true} glowColor="green" className="w-full p-8 min-h-[500px]">
  ...
  return (
    <>
      <div className="flex flex-col justify-center items-center text-center px-4">
        <h3 className="font-display text-xl font-bold mb-4 text-white uppercase tracking-widest opacity-90">Ingestion Phase</h3>
        <p className="text-white/60 font-source-serif text-[15px] leading-relaxed mb-8 max-w-md italic">
          Aegis begins by accepting your legacy Cloud Deployment via GitHub integration or direct ZIP upload. Our ingestion module parses every <code className="bg-white/5 px-1 rounded text-white/90">.tf</code>, mapping dependencies to reconstruct your complete GCP architectural topology.
        </p>
      </div>
      <div className="flex flex-col space-y-4">
        <div 
          onClick={handleStartDemo}
          className="w-full border-2 border-dashed border-white/10 rounded-xl bg-black/30 p-10 flex flex-col items-center justify-center cursor-pointer hover:border-[#39FF14]/40 hover:bg-[#39FF14]/5 transition-all duration-300"
        >
          <div className="w-12 h-12 rounded-full bg-white/5 flex items-center justify-center mb-4">
            {isStarting ? <Loader2 className="animate-spin text-[#39FF14]" /> : <span className="text-xl">📁</span>}
          </div>
        ...
        <CodeBox title="gcp/main.tf" titleColor="text-white/50" borderColor="border-white/10">
          <span className="text-[#FFB800]">resource</span> <span className="text-[#39FF14]">&quot;google_compute_instance&quot; &quot;app_server&quot;</span> {"{\n"}
...
function Step2() {
  return (
    <>
      <div className="flex flex-col justify-center items-center text-center px-4">
        <h3 className="font-display text-xl font-bold mb-4 text-white uppercase tracking-widest opacity-90">Tech Debt Analysis</h3>
        <p className="text-white/60 font-source-serif text-[15px] leading-relaxed mb-8 max-w-md italic">
...
function Step3() {
  return (
    <>
      <div className="flex flex-col justify-center items-center text-center px-4">
         <h3 className="font-display text-xl font-bold mb-4 text-white uppercase tracking-widest opacity-90">AWS Translation</h3>
         <p className="text-white/60 font-source-serif text-[15px] leading-relaxed mb-8 max-w-md italic">
      ...
      <div className="grid grid-cols-2 gap-4">
        <CodeBox title="GCP (Before)" titleColor="text-[#FF4444]" borderColor="border-[#FF4444]/30">
          <span className="text-[#FFB800]">resource</span> <span className="text-[#39FF14]">&quot;google_compute_instance&quot; &quot;app&quot;</span> {"{\n"}
          {"  "}machine_type = <span className="text-[#39FF14]">&quot;n2-standard-4&quot;</span>{"\n"}
          ...{"\n}\n"}
          <span className="text-[#FFB800]">resource</span> <span className="text-[#39FF14]">&quot;google_pubsub_topic&quot; &quot;events&quot;</span> {"{ ... }\n"}
          <span className="text-[#FFB800]">resource</span> <span className="text-[#39FF14]">&quot;google_sql_database_instance&quot; &quot;db&quot;</span> {"{ ... }\n"}
        </CodeBox>
        ...
        <CodeBox title="AWS (After)" titleColor="text-[#39FF14]" borderColor="border-[#39FF14]/30">
          <div className="pl-2 border-l-2 border-[#39FF14]/30">
            <span className="text-[#FFB800]">resource</span> <span className="text-[#39FF14]">&quot;aws_instance&quot; &quot;app&quot;</span> {"{\n"}
            {"  "}instance_type = <span className="text-[#39FF14]">&quot;t3.xlarge&quot;</span>{"\n"}
            {"  "}ami           = data.aws_ami.amazon_linux.id{"\n"}
            ...{"\n}\n"}
            <span className="text-[#FFB800]">resource</span> <span className="text-[#39FF14]">&quot;aws_sqs_queue&quot; &quot;events&quot;</span> {"{ ... }\n"}
            <span className="text-[#FFB800]">resource</span> <span className="text-[#39FF14]">&quot;aws_rds_instance&quot; &quot;db&quot;</span> {"{\n"}
...
function Step4() {
  return (
    <>
      <div className="flex flex-col justify-center items-center text-center px-4">
         <h3 className="font-display text-xl font-bold mb-4 text-white uppercase tracking-widest opacity-90">Zero-Trust IAM</h3>
         <p className="text-white/60 font-source-serif text-[15px] leading-relaxed mb-8 max-w-md italic">
...
function Step5() {
  return (
    <>
      <div className="flex flex-col justify-center items-center text-center px-4">
         <h3 className="font-display text-xl font-bold mb-4 text-white uppercase tracking-widest opacity-90">SOC-2 Audit PDF</h3>
         <p className="text-white/60 font-source-serif text-[15px] leading-relaxed mb-8 max-w-md italic">
         ...
         <button className="px-6 py-3 rounded-xl border border-[#39FF14]/30 bg-[#39FF14]/10 text-[#39FF14] font-mono text-xs hover:bg-[#39FF14]/20 hover:shadow-[0_0_20px_rgba(57,255,20,0.2)] transition-all duration-300">
